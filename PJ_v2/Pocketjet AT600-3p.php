      ...
      <div class="container">
        <div class="row text-center justify-content-center">
            <div class="col-sm-6 col-md-6 col-6">
                <img src="imagenes/ATP600.jpg" alt="" class="mt-4 img-fluid" style="">
            </div>
            <div class="col-md-6 col-sm-12 col-12">
                <h1>Pocketjet AT600 Online Printer</h1>
                <p class="fs-5">Ideal para emprendedores, micro, pequeña y mediana empresas que requieren
                   ...
                   La facilidad de configurar el equipo con
                    1 o más cabezales proporcionan una gran ventaja contra otras opciones del mercado, ya
                     que puede imprimir con diferentes colores en gran formato </p>
