      ...
      <div class="container-fluid">
        <div class="row text-center justify-content-center">
            <div class="col-sm-6 col-md-6 col-6">
                <img src="imagenes/impresora3.jpg" alt="" class=" mt-4 img-fluid" style="">
                <img src="imagenes/controlador.jpg" alt="" class=" mt-2 img-fluid">
            </div>
            <div class="col-md-6 col-sm-12 col-12">
                <h1>PJ600 Series online printer</h1>
                <p class="fs-5">Ideal para emprendedores, micro, pequeña y mediana empresas
                     que requieren de mayor fluidez en sus procesos de producción.<br><br> 
                     
                     La facilidad
                      de configurar el equipo con 1 o más cabezales proporcionan una gran ventaja
                       contra otras opciones del mercado, ya que puede imprimir con diferentes colores
                        en gran formato.  
            ...
            <div class="container-fluid">
              ...
              <div class="collapse" id="collapseExample">
                <div class="card card-body">
                  <ul class="fs-4">
                    - Impresión de 1 mm hasta 76.2 mm de alto <br>
                    - De 1 a 6 cabezales de impresión <br>
                    - Velocidad de 60m/min a 300 dpi <br>
